        ...
        <div className="flex-1 overflow-auto p-6 space-y-6">
          ...
          <section className="p-5 space-y-4" style={{ background: "var(--surface)", border: "1px solid var(--border)" }}>
            <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_auto] gap-3 items-end">
              ...
              <div>
                <label className="text-[9px] tracking-[0.3em] font-bold uppercase mb-1.5 block" style={{ color: "var(--text-faint)" }}>Range</label>
              ...
              <button className="px-4 py-2 text-[10px] font-bold tracking-[0.3em] uppercase transition-colors"
