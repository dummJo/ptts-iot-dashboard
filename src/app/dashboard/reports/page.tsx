  ...
  return (
    <div className="flex min-h-screen" style={{ background:"var(--bg)" }}>
      ...
      <main className="flex-1 overflow-auto flex flex-col">
        <TopBar title="TRENDS" onRefresh={handleRefresh} refreshing={refreshing} connected={dashboardData?.system?.connected} pollInterval={pollInterval} onPollChange={setPollInterval} />
